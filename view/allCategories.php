                            ...
                            <tbody>
                                ...
                                foreach ($categories as $categorie) {
                                    ...
                                    <tr class="hover:bg-gray-100">
                                        ...
                                        <td class="px-4 py-2 border">' . $categorie['name'] . '</td>
                                        <td class="px-4 py-2 border">
                                            <a href="./forms/updateCategory.php?id=' . $categorie['id'] . '" class="text-yellow-500 hover:text-yellow-600 mx-2"><i class="fa-solid fa-pen"></i></a>
                                            <a href="../model/Category.php?action=delete&id=' . $categorie['id'] . '" class="text-red-500 hover:text-red-600 mx-2"><i class="fa-solid fa-trash"></i></a>
                                        </td>
                                    </tr>';
                                } ?>
                            </tbody>
