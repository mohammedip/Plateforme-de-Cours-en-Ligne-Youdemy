...
<div class="ml-64 flex-1 flex flex-col">
    ...
    <div class="flex-1 flex items-center justify-center p-6">
        <div class="container mx-auto w-full max-w-md bg-white shadow-md rounded-lg p-8">
            <h2 class="text-center text-2xl font-bold mb-6">Update Catégories</h2>

            <form action="../../model/Category.php?action=update" method="POST" class="space-y-4">
                <div class="mb-4">
    ...
    <?php
    $categorie = Category::getCategorie($_GET['id']);
