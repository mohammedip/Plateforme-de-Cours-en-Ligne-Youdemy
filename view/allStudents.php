            ...
            <div class="p-6 flex-grow">
                ...
                <div class="bg-white shadow-md rounded-lg">
                    <div class="p-4 border-b">
                        <h2 class="text-lg font-bold text-gray-800">All Etudiants</h2>
                    </div>
                    <div class="p-4 overflow-x-auto">
                        <table class="table-auto w-full text-left border-collapse border border-gray-200">
                            ...
                            <tbody>
                                <?php $etudiants = Etudiant::getAllMembers();
                                foreach ($etudiants as $etudiant) {
                                    echo '
                                    <tr class="hover:bg-gray-100">
                                        <td class="px-4 py-2 border">' . $etudiant['id'] . '</td>
                                        <td class="px-4 py-2 border">' . $etudiant['username'] . '</td>
                                        <td class="px-4 py-2 border">' . $etudiant['email'] . '</td>
                                        <td class="px-4 py-2 border">' . $etudiant['bio'] . '</td>
                                        <td class="px-4 py-2 border">' . $etudiant['statutCompte'] . '</td>
                                        <td class="px-4 py-2 border">
                                            <a href="../model/Admin.php?statut=activate&role=etudiant&id=' . $etudiant['id'] . '"
                                            class="px-4 py-2 border border-green-500 text-white bg-green-500  rounded-lg mx-2">
                                            Activate
                                            </a>
                                            <a href="../model/Admin.php?statut=suspend&role=etudiant&id=' . $etudiant['id'] . '"
                                            class="px-4 py-2 border border-yellow-500 text-white bg-yellow-500  rounded-lg mx-2">
                                            Suspend
                                            </a>
                                            <a href="../model/Admin.php?statut=delete&role=etudiant&id=' . $etudiant['id'] . '"
